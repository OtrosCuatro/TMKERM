...
<!-- ==== Permisos personalizados de Emi ==== -->

<div>
    <?php
    echo form_checkbox("can_use_quick_actions", "1", $can_use_quick_actions ? true : false, "id='can_use_quick_actions' class='form-check-input custom-feature'");
    ?>
    <label for="can_use_quick_actions">
        Usar acciones rápidas <span class="badge bg-warning text-dark">Custom</span>
    </label>
</div>

<div>
    <?php
    echo form_checkbox("can_change_badges", "1", $can_change_badges ? true : false, "id='can_change_badges' class='form-check-input custom-feature'");
    ?>
    <label for="can_change_badges">
        Cambiar badges (colores/textos) <span class="badge bg-warning text-dark">Custom</span>
    </label>
</div>

<div>
    <?php
    echo form_checkbox("can_use_context_menu", "1", $can_use_context_menu ? true : false, "id='can_use_context_menu' class='form-check-input custom-feature'");
    ?>
    <label for="can_use_context_menu">
        Usar menú contextual <span class="badge bg-warning text-dark">Custom</span>
    </label>
</div>

<div>
    <?php
    echo form_checkbox("can_view_extra_columns", "1", $can_view_extra_columns ? true : false, "id='can_view_extra_columns' class='form-check-input custom-feature'");
    ?>
    <label for="can_view_extra_columns">
        Ver columnas extra en eventos <span class="badge bg-warning text-dark">Custom</span>
    </label>
</div>
                ...
                <li>
    <span data-feather="key" class="icon-14 ml-20"></span>
    <h5>Opciones de menú click derecho:</h5>

    <div>
        <?php echo form_checkbox("asignar_smd", "1", $asignar_smd ? true : false, "id='asignar_smd' class='form-check-input'"); ?>
        <label for="asignar_smd">Asignar SMD</label>
    </div>

    <div>
        <?php echo form_checkbox("asignar_ird", "1", $asignar_ird ? true : false, "id='asignar_ird' class='form-check-input'"); ?>
        <label for="asignar_ird">Asignar IRD</label>
    </div>

    <div>
        <?php echo form_checkbox("asignar_cv", "1", $asignar_cv ? true : false, "id='asignar_cv' class='form-check-input'"); ?>
        <label for="asignar_cv">Asignar CV</label>
    </div>

    <div>
        <?php echo form_checkbox("asignar_ig", "1", $asignar_ig ? true : false, "id='asignar_ig' class='form-check-input'"); ?>
        <label for="asignar_ig">Asignar IG</label>
    </div>

    <div>
        <?php echo form_checkbox("estado_cargado", "1", $estado_cargado ? true : false, "id='estado_cargado' class='form-check-input'"); ?>
        <label for="estado_cargado">Cargado</label>
    </div>

    <div>
        <?php echo form_checkbox("estado_chequeado", "1", $estado_chequeado ? true : false, "id='estado_chequeado' class='form-check-input'"); ?>
        <label for="estado_chequeado">Chequeado</label>
    </div>

    <div>
        <?php echo form_checkbox("estado_faltan_datos", "1", $estado_faltan_datos ? true : false, "id='estado_faltan_datos' class='form-check-input'"); ?>
        <label for="estado_faltan_datos">Faltan datos</label>
    </div>

    <div>
        <?php echo form_checkbox("estado_grabando", "1", $estado_grabando ? true : false, "id='estado_grabando' class='form-check-input'"); ?>
        <label for="estado_grabando">Grabando</label>
    </div>

    <div>
        <?php echo form_checkbox("estado_backup", "1", $estado_backup ? true : false, "id='estado_backup' class='form-check-input'"); ?>
        <label for="estado_backup">Backup</label>
    </div>

    <div>
        <?php echo form_checkbox("estado_finalizado", "1", $estado_finalizado ? true : false, "id='estado_finalizado' class='form-check-input'"); ?>
...
<li>
    <span data-feather="key" class="icon-14 ml-20"></span>
    <h5>Permisos de eventos:</h5>

    <div>
        <?php echo form_checkbox(
            "can_edit_public_events", 
            "1", 
            $can_edit_public_events ? true : false, 
            "id='can_edit_public_events' class='form-check-input'"
        ); ?>
        <label for="can_edit_public_events">Puede editar eventos públicos</label>
    </div>
...
<div>
    <?php echo form_checkbox(
        "can_delete_event", 
        "1", 
        $can_delete_event ? true : false, 
        "id='can_delete_event' class='form-check-input'"
        ); ?>
    <label for="can_delete_event">Puede eliminar eventos</label>
</div>
...
<li>
    <span data-feather="key" class="icon-14 ml-20"></span>
    <h5>Vista de evento:</h5>

    <div>
        <?php echo form_checkbox("can_view_event_details", "1", $can_view_event_details ? true : false, "id='can_view_event_details' class='form-check-input'"); ?>
        <label for="can_view_event_details">Puede ver detalles técnicos del evento (SMD, Conv, IG, ASI IP)</label>
    </div>
</li>
...
<style>/* Estilo común para todos los permisos personalizados */
.custom-feature {
    accent-color: #ff9800;   /* cambia el color del checkbox (soportado en navegadores modernos) */
}

.permission-list .custom-feature + label {
    font-weight: bold;
    color: #e65100;
}
</style>
