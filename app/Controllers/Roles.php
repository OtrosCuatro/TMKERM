...
class Roles extends Security_Controller {
    ...
    function permissions($role_id) {
        if ($role_id) {
            ...
            $view_data['can_use_quick_actions'] = get_array_value($permissions, "can_use_quick_actions");
            $view_data['can_change_badges'] = get_array_value($permissions, "can_change_badges");
            $view_data['can_use_context_menu'] = get_array_value($permissions, "can_use_context_menu");
            $view_data['can_view_extra_columns'] = get_array_value($permissions, "can_view_extra_columns");

            // === permisos de menú contextual personalizados ===
$view_data['asignar_smd'] = get_array_value($permissions, "asignar_smd");
$view_data['asignar_ird'] = get_array_value($permissions, "asignar_ird");
$view_data['asignar_cv'] = get_array_value($permissions, "asignar_cv");
$view_data['asignar_ig'] = get_array_value($permissions, "asignar_ig");

$view_data['estado_cargado'] = get_array_value($permissions, "estado_cargado");
$view_data['estado_chequeado'] = get_array_value($permissions, "estado_chequeado");
$view_data['estado_faltan_datos'] = get_array_value($permissions, "estado_faltan_datos");
$view_data['estado_grabando'] = get_array_value($permissions, "estado_grabando");
$view_data['estado_backup'] = get_array_value($permissions, "estado_backup");
$view_data['estado_finalizado'] = get_array_value($permissions, "estado_finalizado");


$view_data['can_edit_public_events'] = get_array_value($permissions, "can_edit_public_events");

$view_data['can_view_event_details'] = get_array_value($permissions, "can_view_event_details");
$view_data['can_delete_event'] = get_array_value($permissions, "can_delete_event");
    ...
    function save_permissions() {
        ...
        // === permisos personalizados de Emi ===
$can_use_quick_actions = $this->request->getPost('can_use_quick_actions');
$can_change_badges = $this->request->getPost('can_change_badges');
$can_use_context_menu = $this->request->getPost('can_use_context_menu');
$can_view_extra_columns = $this->request->getPost('can_view_extra_columns');


// === permisos de menú contextual personalizados ===
$asignar_smd = $this->request->getPost('asignar_smd');
$asignar_ird = $this->request->getPost('asignar_ird');
$asignar_cv = $this->request->getPost('asignar_cv');
$asignar_ig = $this->request->getPost('asignar_ig');

$estado_cargado = $this->request->getPost('estado_cargado');
$estado_chequeado = $this->request->getPost('estado_chequeado');
$estado_faltan_datos = $this->request->getPost('estado_faltan_datos');
$estado_grabando = $this->request->getPost('estado_grabando');
$estado_backup = $this->request->getPost('estado_backup');
$estado_finalizado = $this->request->getPost('estado_finalizado');


$can_edit_public_events = $this->request->getPost('can_edit_public_events');

$can_delete_event = $this->request->getPost('can_delete_event');



$can_view_event_details = $this->request->getPost('can_view_event_details');
        ...
        $permissions = array(
            ...
            "can_comment_on_projects" => $can_comment_on_projects,
                ...
                // === permisos personalizados de Emi ===
    "can_use_quick_actions" => $can_use_quick_actions,
    "can_change_badges" => $can_change_badges,
    "can_use_context_menu" => $can_use_context_menu,
    "can_view_extra_columns" => $can_view_extra_columns,


    // === permisos de menú contextual personalizados ===
"asignar_smd" => $asignar_smd,
"asignar_ird" => $asignar_ird,
"asignar_cv" => $asignar_cv,
"asignar_ig" => $asignar_ig,

"estado_cargado" => $estado_cargado,
"estado_chequeado" => $estado_chequeado,
"estado_faltan_datos" => $estado_faltan_datos,
"estado_grabando" => $estado_grabando,
"estado_backup" => $estado_backup,
"estado_finalizado" => $estado_finalizado,


"can_edit_public_events" => $can_edit_public_events,
// Por ejemplo en tu sistema de roles
"can_delete_event" => $can_delete_event,



"can_view_event_details" => $can_view_event_details,
